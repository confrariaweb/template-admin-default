                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm" role="group" aria-label="Templates">
                                <a href="{{ route('admin.templates.show', $template->id) }}" class="btn btn-primary">Ver</a>
                                <a href="{{ route('admin.templates.edit', $template->id) }}" class="btn btn-secondary">Editar</a>
                                <a href="{{ route('admin.templates.destroy', $template->id) }}" class="btn btn-danger">Deletar</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
